...
The new man:rtw88[4] driver introduces IEEE 802.11n/ac support for Realtek chips such as the RTL8822CE. 
Background: https://wiki.freebsd.org/WiFi/Rtw88[].
gitref:b130a058aaf8[repository=src]
...
They can be configured via man:route[8] and a part of the modular FIB lookup mechanism.
