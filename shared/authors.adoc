...
:alven-name: Älven
:alven-email: alven@FreeBSD.org
:alven: {alven-name} <{alven-email}>
...
:aokblast-name: ShengYi Hung
:aokblast-email: aokblast@FreeBSD.org
:aokblast: {aokblast-name} <{aokblast-email}>
...
:dtxdf-name: Jesús Daniel Colmenares Oviedo
:dtxdf-email: dtxdf@FreeBSD.org
:dtxdf: {dtxdf-name} <{dtxdf-email}>
...
:igoro-name: Igor Ostapenko
:igoro-email: igoro@FreeBSD.org
:igoro: {igoro-name} <{igoro-email}>
...
:jaeyoon-name: Jaeyoon Choi
:jaeyoon-email: jaeyoon@FreeBSD.org
:jaeyoon: {jaeyoon-name} <{jaeyoon-email}>
...
:jlduran-name: Jose Luis Duran
:jlduran-email: jlduran@FreeBSD.org
:jlduran: {jlduran-name} <{jlduran-email}>
...
:jrhall-name: John Hall
:jrhall-email: jrhall@FreeBSD.org
:jrhall: {jrhall-name} <{jrhall-email}>
...
:js-name: Johan Söllvander
:js-email: js@FreeBSD.org
:js: {js-name} <{js-email}>
...
:kgalazka-name: Krzysztof Galazka
:kgalazka-email: kgalazka@FreeBSD.org
:kgalazka: {kgalazka-name} <{kgalazka-email}>

:khng-name: Ka Ho Ng
:khng-email: khng@FreeBSD.org
:khng: {khng-name} <{khng-email}>

:khorben-name: Pierre Pronchery
:khorben-email: khorben@FreeBSD.org
:khorben: {khorben-name} <{khorben-email}>
...
:laurent-name: Laurent Chardon
:laurent-email: laurent@FreeBSD.org
:laurent: {laurent-name} <{laurent-email}>
...
:mce-name: Kousuke Kannagi
:mce-email: mce@FreeBSD.org
:mce: {mce-name} <{mce-email}>
...
:nxjoseph-name: Yusuf Yaman
:nxjoseph-email: nxjoseph@FreeBSD.org
:nxjoseph: {nxjoseph-name} <{nxjoseph-email}>

:nyan-name: Yoshihiro Takahashi
:nyan-email: nyan@FreeBSD.org
:nyan: {nyan-name} <{nyan-email}>

:obiwac-name: Aymeric Wibo
:obiwac-email: obiwac@FreeBSD.org
:obiwac: {obiwac-name} <{obiwac-email}>
...
:osamaabb-name: Osama Abboud
:osamaabb-email: osamaabb@FreeBSD.org
:osamaabb: {osamaabb-name} <{osamaabb-email}>
...
:pouria-name: Pouria Mousavizadeh Tehrani
:pouria-email: pouria@FreeBSD.org
:pouria: {pouria-name} <{pouria-email}>
...
:siva-name: Siva Mahadevan
:siva-email: siva@FreeBSD.org
:siva: {siva-name} <{siva-email}>
...
:smyru-name: Piotr Smyrak
:smyru-email: smyru@FreeBSD.org
:smyru: {smyru-name} <{smyru-email}>
...
:tpearson-name: Timothy Pearson
:tpearson-email: tpearson@FreeBSD.org
:tpearson: {tpearson-name} <{tpearson-email}>
...
:vexeduxr-name: Ahmad Khalifa
:vexeduxr-email: vexeduxr@FreeBSD.org
:vexeduxr: {vexeduxr-name} <{vexeduxr-email}>
...
:vladlen-name: Vladlen Popolitov
:vladlen-email: vladlen@FreeBSD.org
:vladlen: {vladlen-name} <{vladlen-email}>
...
:ziaee-name: Alexander Ziaee
:ziaee-email: ziaee@FreeBSD.org
:ziaee: {ziaee-name} <{ziaee-email}>
...
// FreeBSD Core Team
:core-members: {allanjude}, {dch}, {glebius}, {hrs}, {lwhsu}, {mat}, {olivier}
:core-secretary-email: core-secretary@FreeBSD.org

// FreeBSD Doc Engineering Team
:doceng-members: {blackend}, {hrs}, {ebrandi}
...
:portmgr-members: {mat}, {bapt}, {pizzamig}, {rene}, {dvl}

// FreeBSD Release Engineering Teams
:re: re@FreeBSD.org
:re-members: {carlavilla}, {dch}, {blackend}, {leres}, {delphij}, {emaste}, {cperciva}, {bofh}, {vladlen}, {ivy}, {ziaee}
:re-members-email: {carlavilla-email}, {dch-email}, {blackend-email}, {leres-email}, {delphij-email}, {emaste-email}, {cperciva-email}, {bofh-email}, {vladlen-email}, {ivy-email}, {ziaee-email}
