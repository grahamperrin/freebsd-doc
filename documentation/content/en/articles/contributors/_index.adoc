...
[NOTE]
====
As of 2010, the following section was several years out-of-date. Donations from the past several years appear https://www.FreeBSD.org/donations/donors/[here].
====
