...
FreeBSD 11.0-RELEASE incuded link:https://www.freebsd.org/releases/11.0R/relnotes/#storage-general[TRIM/UNMAP support on GELI-backed SSD storage providers]. 
